document.addEventListener("DOMContentLoaded", function () {
    ...
    // Add this function to handle scroll animations for Vid Two section
    ...
    const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                const lines = entry.target.querySelectorAll('.vid-two-content > *');
                ...
                // Show notification when this section comes into view
                showNotification("A Special Thank You Message", 3000);
            }
        });
    }, {
        threshold: 0.3
...
// Update the initialize function to include vid two section
function initialize() {
